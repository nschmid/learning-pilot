    ...
    <body class="font-sans antialiased">
        ...
        <div class="min-h-screen bg-gray-100" x-data="{ sidebarOpen: false }">
            ...
            <div class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
                <div class="flex min-h-0 flex-1 flex-col bg-teal-700">
                    @include('components.layouts.admin-sidebar-content')
                </div>
            </div>
            ...
            <div class="lg:pl-64 flex flex-col flex-1">
                ...
                <div class="sticky top-0 z-10 flex h-16 shrink-0 bg-white shadow">
                    <button type="button" class="px-4 border-r border-gray-200 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-500 lg:hidden" @click="sidebarOpen = true">
