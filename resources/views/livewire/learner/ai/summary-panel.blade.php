            ...
            @else
                ...
                <div class="space-y-6">
                                ...
                                <ul class="space-y-3">
                                    @foreach($summary['key_points'] as $point)
                                        <li class="flex items-start gap-3">
                                            <svg class="size-5 flex-shrink-0 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="{{ route('learner.ai.practice', $moduleId) }}" class="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-500">
