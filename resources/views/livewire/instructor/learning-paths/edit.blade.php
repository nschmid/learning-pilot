<div class="mx-auto max-w-3xl">
    ...
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">{{ __('Lernpfad bearbeiten') }}</h1>
        <p class="mt-1 text-gray-500">{{ __('Aktualisiere die Grundinformationen deines Kurses.') }}</p>
    </div>
            ...
            <div>
                ...
                <div class="mt-1 flex items-center gap-4">
                    ...
                    @elseif($existingThumbnail)
                        <div class="relative">
                            <img src="{{ $existingThumbnail }}" alt="Current thumbnail" class="h-24 w-40 rounded-lg object-cover">
                            <button
