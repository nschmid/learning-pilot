    ...
    <div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                <h2 class="text-base font-semibold text-indigo-600">{{ __('Kontakt') }}</h2>
            ...
            <div class="mx-auto mt-16 max-w-xl">
                @if($submitted)
                    <div class="rounded-lg bg-green-50 p-6 text-center">
                        ...
                        <button wire:click="$set('submitted', false)" class="mt-6 text-sm font-semibold text-indigo-600 hover:text-indigo-500">
                ...
                @else
                    <form wire:submit="submit" class="space-y-6">
                        ...
                        <div>
                            <button
                                type="submit"
                                class="w-full rounded-lg bg-indigo-600 px-4 py-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 transition"
            ...
            <div class="mx-auto mt-16 max-w-2xl">
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
                    <div class="text-center">
                        <svg class="mx-auto size-8 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
