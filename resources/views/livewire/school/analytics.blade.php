<div>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <select wire:model.live="period" class="rounded-lg border-gray-300 text-sm focus:border-teal-500 focus:ring-teal-500">
            ...
            <div class="grid gap-6 sm:grid-cols-3">
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    <div class="p-5">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <svg class="size-6 text-teal-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <div class="h-64">
                                <div class="flex h-full items-end gap-1">
                                    ...
                                    @foreach($enrollmentsOverTime as $date => $count)
                                        <div
                                            class="flex-1 rounded-t bg-teal-500 transition-all hover:bg-teal-600"
