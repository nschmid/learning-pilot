    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="mb-6 overflow-hidden rounded-lg bg-white shadow">
                    <div class="px-4 py-5 sm:px-6">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('billing.plans') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                                {{ __('Plan ändern') }}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="px-4 py-5 sm:px-6">
                        ...
                        <div class="mt-4">
                            <div class="h-4 overflow-hidden rounded-full bg-gray-200">
                                <div
                                    class="h-4 rounded-full {{ $stats['students']['percent'] > 90 ? 'bg-red-500' : ($stats['students']['percent'] > 70 ? 'bg-yellow-500' : 'bg-indigo-600') }}"
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    <div class="px-4 py-5 sm:px-6">
                        ...
                        <div class="mt-4">
                            <div class="h-4 overflow-hidden rounded-full bg-gray-200">
                                <div
                                    class="h-4 rounded-full {{ $stats['instructors']['percent'] > 90 ? 'bg-red-500' : ($stats['instructors']['percent'] > 70 ? 'bg-yellow-500' : 'bg-indigo-600') }}"
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    <div class="px-4 py-5 sm:px-6">
                        ...
                        <div class="mt-4">
                            <div class="h-4 overflow-hidden rounded-full bg-gray-200">
                                <div
                                    class="h-4 rounded-full {{ $stats['storage']['percent'] > 90 ? 'bg-red-500' : ($stats['storage']['percent'] > 70 ? 'bg-yellow-500' : 'bg-indigo-600') }}"
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    <div class="px-4 py-5 sm:px-6">
                        ...
                        <div class="mt-4">
                            <div class="h-4 overflow-hidden rounded-full bg-gray-200">
                                <div
                                    class="h-4 rounded-full {{ $stats['ai_requests']['daily_percent'] > 90 ? 'bg-red-500' : ($stats['ai_requests']['daily_percent'] > 70 ? 'bg-yellow-500' : 'bg-indigo-600') }}"
                ...
                <div class="border-t border-gray-200">
                    <dl class="grid grid-cols-1 divide-y divide-gray-200 sm:grid-cols-3 sm:divide-x sm:divide-y-0">
                        ...
                        <div class="px-4 py-5 text-center sm:px-6">
                            ...
                            <dd class="mt-1 text-3xl font-semibold text-indigo-600">{{ $stats['enrollments']['active'] }}</dd>
                        </div>
                        <div class="px-4 py-5 text-center sm:px-6">
            ...
            @if($stats['students']['percent'] > 80 || $stats['storage']['percent'] > 80)
                <div class="mt-8 rounded-lg bg-indigo-600 px-4 py-8 text-center sm:px-6">
                    <h3 class="text-lg font-medium text-white">{{ __('Mehr Kapazität benötigt?') }}</h3>
                    <p class="mt-2 text-sm text-indigo-200">{{ __('Upgraden Sie auf einen höheren Plan für mehr Lernende, Speicher und Funktionen.') }}</p>
                    <a href="{{ route('billing.plans') }}" class="mt-4 inline-flex items-center rounded-lg bg-white px-4 py-2 text-sm font-medium text-indigo-600 hover:bg-indigo-50">
                        {{ __('Pläne ansehen') }}
                    </a>
                </div>
            @endif
