            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    ...
                    <div class="bg-gray-50 px-5 py-3">
                        <a href="{{ route('school.students') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">{{ __('Verwalten') }}</a>
                    </div>
                </div>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    ...
                    <div class="bg-gray-50 px-5 py-3">
                        <a href="{{ route('school.students') }}?role=instructor" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">{{ __('Verwalten') }}</a>
                    </div>
                </div>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    ...
                    <div class="bg-gray-50 px-5 py-3">
                        <a href="{{ route('instructor.paths.index') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">{{ __('Alle ansehen') }}</a>
                    </div>
                </div>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    ...
                    <div class="bg-gray-50 px-5 py-3">
                        <a href="{{ route('school.analytics') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">{{ __('Details') }}</a>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8">
                ...
                <div class="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <a href="{{ route('school.students.import') }}" class="flex items-center gap-3 rounded-lg border border-gray-200 bg-white p-4 hover:bg-gray-50">
                        <svg class="size-6 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    ...
                    <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
                        ...
                        <div class="mt-2 h-3 overflow-hidden rounded-full bg-gray-200">
                            <div class="h-3 rounded-full {{ $stats['storage']['percent'] > 90 ? 'bg-red-500' : ($stats['storage']['percent'] > 70 ? 'bg-yellow-500' : 'bg-indigo-600') }}" style="width: {{ $stats['storage']['percent'] }}%"></div>
                        </div>
                    </div>
                </div>
            </div>
