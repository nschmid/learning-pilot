<div>
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4">
            <a href="{{ route('admin.teams.index') }}" class="rounded-lg border border-gray-300 p-2 hover:bg-gray-50">
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6">
        <form wire:submit="save" class="space-y-6">
            ...
            <div>
                ...
                <div class="max-h-48 overflow-y-auto rounded-lg border border-gray-200">
                    @forelse($this->availableOwners as $user)
                        <label class="flex cursor-pointer items-center gap-3 px-4 py-3 hover:bg-gray-50 {{ $ownerId === (string) $user->id ? 'bg-indigo-50' : '' }}">
            ...
            <div class="flex justify-end gap-3 border-t border-gray-200 pt-6">
                <a href="{{ route('admin.teams.index') }}" class="rounded-lg border border-gray-300 px-4 py-2 text-gray-700 hover:bg-gray-50">
                    {{ __('Abbrechen') }}
                </a>
