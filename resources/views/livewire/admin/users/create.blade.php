            ...
            <div class="mb-6">
                ...
                <div class="mt-1 flex gap-2">
                    <input
                        ...
                        type="text"
                        id="password"
                        class="block w-full rounded-lg border-0 bg-gray-50 ring-1 ring-gray-200 shadow-sm focus:border-teal-500 focus:ring-teal-500"
                    >
                    <button
                        wire:click="generatePassword"
                        type="button"
                        class="shrink-0 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition"
                    >
                        {{ __('Generieren') }}
                    </button>
                </div>
